...
<div id="interfaceProject">
    ...
    <div v-for="project in projects">{{project.name}}</div>

    

    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
        <span>项目名称</span><el-input v-model="newProjectName" placeholder="项目名称"></el-input>
...
export default {
    ...
    methods: {
        ...
        saveNewProject() {
            this.newProjectName.push(this.projects)
